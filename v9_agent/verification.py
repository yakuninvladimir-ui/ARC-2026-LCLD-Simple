...
class VerificationBinder:
    ...
    def bind(self, step: TestStep, snapshot: ARGALiteSnapshot, hypothesis_id: str | None = None) -> VerificationContract | None:
        ...
        semantic_binding = step.semantic_binding
        ...
        contract_id = stable_hash((
            ...
            kind.value,
            metric_name,
            semantic_binding.binding_id if semantic_binding else None,
        ), "vc_")
        semantic_metric = semantic_binding.metric_spec if semantic_binding else None
        return VerificationContract(
            ...
            semantic_binding_id=semantic_binding.binding_id if semantic_binding else None,
            goal_operator=semantic_binding.goal_operator if semantic_binding else None,
            source_object_ids=semantic_binding.source_object_ids if semantic_binding else (),
            reference_object_ids=semantic_binding.reference_object_ids if semantic_binding else (),
            semantic_metric_name=semantic_metric.name if semantic_metric else None,
            metric_direction=semantic_metric.direction if semantic_metric else None,
            metric_target_value=semantic_metric.target_value if semantic_metric else None,
            metric_epsilon=semantic_metric.epsilon if semantic_metric else 1e-6,
        )
